...
ftc_updateWorld = function() {
  ...
  const template = duplicate(game.locals.gameList[PFTC_SYSTEM_IDENTIFIER]);
...
function ftc_promptUpdate() {
    ...
    // Is it a v1 build?
  let ver = game.locals.gameList[PFTC_SYSTEM_IDENTIFIER].version;
...
hook.add("PFTCInit", "Migration", function() {
    ftc_promptUpdate();
});
