/* jshint -W104 */
hook.add("PFTCInit", "Forms", function() {
PFTC.forms = {};

/* -------------------------------------------- */
/* Delayed Input Updating                       */
/* -------------------------------------------- */
PFTC.forms.delayedUpdate = function(entity, ms) {
    setTimeout(function() {
...
PFTC.forms.edit_value_fields = function(html, entity) {
    ...
    inputs.filter('[data-autosize]').each(function() { PFTC.forms.autosize($(this)); });
    ...
    inputs.blur(function() {
        ...
        PFTC.forms.delayedUpdate(entity, ms);
    }).keyup(function(e) {
        if (e.which === 13) $(this).blur();
        PFTC.forms.autosize($(this));
    });
};

PFTC.forms.autosize = function(field) {
...
PFTC.forms.edit_textarea_fields = function(html, entity) {
    ...
    */
    ...
    inputs.blur(function() {
        let input = $(this);
        entity.setData(input.attr('data-edit'), input.val(), input.attr('data-dtype'));
        PFTC.forms.delayedUpdate(entity);
    });
};
...
PFTC.forms.edit_checkbox_fields = function(html, entity) {
...
PFTC.forms.edit_select_fields = function(html, entity) {
...
PFTC.forms.edit_image_fields = function(html, entity, app) {
...
PFTC.forms.edit_mce_fields = function(html, entity, app) {
...
PFTC.forms.edit_item_fields = function(html, character) {
...
PFTC.forms.activateFields = function(html, entity, app) {
